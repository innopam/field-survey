...
export class FarmMap {
    ...
    @Column('geometry', { spatialFeatureType: 'Polygon', srid: 5179 })
    geom: string;
    ...
    @Column({ name: 'cad_con_ra', type: 'decimal', precision: 10, scale: 2, nullable: true })
    cadConRa: number;
    ...
    @Column({ name: 'o_uid', length: 50, nullable: true })
    oUid: string;
